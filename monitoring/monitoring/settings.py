...
SECRET_KEY = 'django-insecure-n$vg14=to_=^pfizj21pj8vmlae*hrps1)eko&m39)4wcpr*%5'
...
LOGGING = {
    ...
    'loggers': {
        # Use module-based loggers everywhere
        # Example: 'network.tasks': {'handlers': ['console', 'file'], 'level': 'INFO', 'propagate': False},
    },
}